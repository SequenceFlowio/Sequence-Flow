...
`}),t}function s(e){let t=e.some(e=>Object.keys(e.alternates??{}).length>0),i=e.some(e=>{var t;return!!(null==(t=e.images)?void 0:t.length)}),n=e.some(e=>{var t;return!!(null==(t=e.videos)?void 0:t.length)}),r="";for(let u of(r+='<?xml version="1.0" encoding="UTF-8"?>\n',r+='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',i&&(r+=' xmlns:image="http://www.google.com/schemas/sitemap-image/1.1"'),n&&(r+=' xmlns:video="http://www.google.com/schemas/sitemap-video/1.1"'),t?r+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':r+=">\n",e)){var s,a,o;r+="<url>\n",r+=`<loc>${u.url}</loc>
`;let e=null==(s=u.alternates)?void 0:s.languages;if(e&&Object.keys(e).length)for(let t in e)r+=`<xhtml:link rel="alternate" hreflang="${t}" href="${e[t]}" />
`;if(null==(a=u.images)?void 0:a.length)for(let e of u.images)r+=`<image:image>
<image:loc>${e}</image:loc>
</image:image>
`;if(null==(o=u.videos)?void 0:o.length)for(let e of u.videos)r+=["<video:video>",`<video:title>${e.title}</video:title>`,`<video:thumbnail_loc>${e.thumbnail_loc}</video:thumbnail_loc>`,`<video:description>${e.description}</video:description>`,e.content_loc&&`<video:content_loc>${e.content_loc}</video:content_loc>`,e.player_loc&&`<video:player_loc>${e.player_loc}</video:player_loc>`,e.duration&&`<video:duration>${e.duration}</video:duration>`,e.view_count&&`<video:view_count>${e.view_count}</video:view_count>`,e.tag&&`<video:tag>${e.tag}</video:tag>`,e.rating&&`<video:rating>${e.rating}</video:rating>`,e.expiration_date&&`<video:expiration_date>${e.expiration_date}</video:expiration_date>`,e.publication_date&&`<video:publication_date>${e.publication_date}</video:publication_date>`,e.family_friendly&&`<video:family_friendly>${e.family_friendly}</video:family_friendly>`,e.requires_subscription&&`<video:requires_subscription>${e.requires_subscription}</video:requires_subscription>`,e.live&&`<video:live>${e.live}</video:live>`,e.restriction&&`<video:restriction relationship="${e.restriction.relationship}">${e.restriction.content}</video:restriction>`,e.platform&&`<video:platform relationship="${e.platform.relationship}">${e.platform.content}</video:platform>`,e.uploader&&`<video:uploader${e.uploader.info&&` info="${e.uploader.info}"`}>${e.uploader.content}</video:uploader>`,`</video:video>
`].filter(Boolean).join("\n");if(u.lastModified){let e=u.lastModified instanceof Date?u.lastModified.toISOString():u.lastModified;r+=`<lastmod>${e}</lastmod>
`}u.changeFrequency&&(r+=`<changefreq>${u.changeFrequency}</changefreq>
`),"number"==typeof u.priority&&(r+=`<priority>${u.priority}</priority>
`),r+="</url>\n"}return r+"</urlset>\n"}function a(e){return JSON.stringify(e)}function o(e,t){return"robots"===t?r(e):"sitemap"===t?s(e):"manifest"===t?a(e):""}},83345,e=>{"use strict";var t=e.i(47909),i=e.i(74017),n=e.i(96250),r=e.i(59756),s=e.i(61916),a=e.i(74677),o=e.i(69741),u=e.i(16795),c=e.i(87718),h=e.i(95169),l=e.i(47587),p=e.i(66012),d=e.i(70101),f=e.i(26937),m=e.i(10372),x=e.i(93695);e.i(52474);var D=e.i(220),y=e.i(89171),g=e.i(14827),E=e.i(2157),C=e.i(50227);let A=(e,t,i)=>{i||(i="title");let n=E.default.readdirSync(e).filter(e=>e.endsWith(".md")).map(t=>{let i=C.default.join(e,t);try{let e=E.default.readFileSync(i,"utf8"),n=(0,g.default)(e);return{...n.data,slug:t.replace(".md",""),content:n.content}}catch(e){return null}}).filter(e=>null!==e).toSorted((e,t)=>{let n=(e,t)=>{let i=e[t];return"string"==typeof i?i:null==i?"":"number"==typeof i||"boolean"==typeof i?String(i):""},r=n(e,i),s=n(t,i);return r.localeCompare(s)});return t?n.reverse():n};function v(){let e=A("src/data/blogs"),t="https://sequenceflow.io";return[...["/","/blog","/oplossingen","/hoe-wij-werken","/contact"].map(e=>({url:`${t}${e}`,lastModified:new Date,changeFrequency:"monthly",priority:"/"===e?1:.8})),...e.map(e=>({url:`${t}/blog/${e.slug}`,lastModified:new Date,changeFrequency:"monthly",priority:.9}))]}e.s(["default",()=>v],63034);var S=e.i(73853);let F="application/xml",k="public, max-age=0, must-revalidate",w="sitemap";async function b(){let e=await v(),t=(0,S.resolveRouteData)(e,w);return new y.NextResponse(t,{headers:{"Content-Type":F,"Cache-Control":k}})}e.s(["GET",()=>b],79512),e.i(79512),e.i(63034),e.s(["GET",()=>b],87576);var B=e.i(87576);let T="standalone",N=new t.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/sitemap--route-entry.js",nextConfigOutput:T,userland:B}),{workAsyncStorage:I,workUnitAsyncStorage:M,serverHooks:P}=N;function O(){return(0,n.patchFetch)({workAsyncStorage:I,workUnitAsyncStorage:M})}async function L(e,t,n){N.isDev&&(0,r.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let y="/sitemap.xml/route";y=y.replace(/\/index$/,"")||"/";let g=!1,E=await N.prepare(e,t,{srcPage:y,multiZoneDraftMode:g});if(!E)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:C,params:A,nextConfig:v,parsedUrl:S,isDraftMode:F,prerenderManifest:k,routerServerContext:w,isOnDemandRevalidate:b,revalidateOnlyGenerated:B,resolvedPathname:T,clientReferenceManifest:I,serverActionsManifest:M}=E,P=(0,o.normalizeAppPath)(y),O=!!(k.dynamicRoutes[P]||k.routes[T]),L=async()=>((null==w?void 0:w.render404)?await w.render404(e,t,S,!1):t.end("This page could not be found"),null);if(O&&!F){let e=!!k.routes[T],t=k.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(v.experimental.adapterPath)return await L();throw new x.NoFallbackError}}let U=null;!O||N.isDev||F||(U="/index"===(U=T)?"/":U);let X=!0===N.isDev||!O,J=O&&!X;M&&I&&(0,a.setManifestsSingleton)({page:y,clientReferenceManifest:I,serverActionsManifest:M});let R=e.method||"GET",j=(0,s.getTracer)(),z=j.getActiveScopeSpan(),_={params:A,prerenderManifest:k,renderOpts:{experimental:{authInterrupts:!!v.experimental.authInterrupts},cacheComponents:!!v.cacheComponents,supportsDynamicResponse:X,incrementalCache:(0,r.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:v.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,i,n,r)=>N.onRequestError(e,t,n,r,w)},sharedContext:{buildId:C}},K=new u.NodeNextRequest(e),H=new u.NodeNextResponse(t),W=c.NextRequestAdapter.fromNodeNextRequest(K,(0,c.signalFromNodeResponse)(t));try{let a=async e=>N.handle(W,_).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let i=j.getRootSpanAttributes();if(!i)return;if(i.get("next.span_type")!==h.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${i.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=i.get("next.route");if(n){let t=`${R} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${R} ${y}`)}),o=!!(0,r.getRequestMeta)(e,"minimalMode"),u=async r=>{var s,u;let c=async({previousCacheEntry:i})=>{try{if(!o&&b&&B&&!i)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await a(r);e.fetchMetrics=_.renderOpts.fetchMetrics;let u=_.renderOpts.pendingWaitUntil;u&&n.waitUntil&&(n.waitUntil(u),u=void 0);let c=_.renderOpts.collectedTags;if(!O)return await (0,p.sendResponse)(K,H,s,_.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,d.toNodeOutgoingHttpHeaders)(s.headers);c&&(t[m.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let i=void 0!==_.renderOpts.collectedRevalidate&&!(_.renderOpts.collectedRevalidate>=m.INFINITE_CACHE)&&_.renderOpts.collectedRevalidate,n=void 0===_.renderOpts.collectedExpire||_.renderOpts.collectedExpire>=m.INFINITE_CACHE?void 0:_.renderOpts.collectedExpire;return{value:{kind:D.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:i,expire:n}}}}catch(t){if(null==i?void 0:i.isStale){let i=!1;await N.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:J,isOnDemandRevalidate:b})},i,w)}throw t}},h=await N.handleResponse({req:e,nextConfig:v,cacheKey:U,routeKind:i.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:k,isRoutePPREnabled:!1,isOnDemandRevalidate:b,revalidateOnlyGenerated:B,responseGenerator:c,waitUntil:n.waitUntil,isMinimalMode:o});if(!O)return null;if((null==h||null==(s=h.value)?void 0:s.kind)!==D.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==h||null==(u=h.value)?void 0:u.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});o||t.setHeader("x-nextjs-cache",b?"REVALIDATED":h.isMiss?"MISS":h.isStale?"STALE":"HIT"),F&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let x=(0,d.fromNodeOutgoingHttpHeaders)(h.value.headers);return o&&O||x.delete(m.NEXT_CACHE_TAGS_HEADER),!h.cacheControl||t.getHeader("Cache-Control")||x.get("Cache-Control")||x.set("Cache-Control",(0,f.getCacheControlHeader)(h.cacheControl)),await (0,p.sendResponse)(K,H,new Response(h.value.body,{headers:x,status:h.value.status||200})),null};z?await u(z):await j.withPropagatedContext(e.headers,()=>j.trace(h.BaseServerSpan.handleRequest,{spanName:`${R} ${y}`,kind:s.SpanKind.SERVER,attributes:{"http.method":R,"http.target":e.url}},u))}catch(t){if(!(t instanceof x.NoFallbackError)){let i=!1;await N.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:J,isOnDemandRevalidate:b})},i,w)}if(O)throw t;return await (0,p.sendResponse)(K,H,new Response(null,{status:500})),null}}e.s(["handler",()=>L,"patchFetch",()=>O,"routeModule",()=>N,"serverHooks",()=>P,"workAsyncStorage",()=>I,"workUnitAsyncStorage",()=>M],83345)}];

//# sourceMappingURL=node_modules_e7440a1d._.js.map