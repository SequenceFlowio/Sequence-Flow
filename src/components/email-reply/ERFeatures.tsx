...
import IntegrationCircle from '@/components/content-gen/IntegrationCircle';
              ...
              <div className="space-y-3">
                <RevealAnimation delay={0.2}>
                  <h2
                    ...
                    Krachtige <span className="text-ns-green">AI e-mail tools</span> voor elk supportteam
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto max-w-[400px] text-center lg:mx-0 lg:text-left">
                    Van e-commerce tot zakelijke dienstverlening — Email Reply schaalt mee met uw team en werkdruk.
                  </p>
                </RevealAnimation>
              </div>
            </div>
              ...
              <RevealAnimation delay={0.1}>
                <div className="relative h-[350px] w-full max-w-[642px] space-y-[98px] overflow-hidden rounded-4xl bg-white p-8 md:p-[42px] lg:h-[450px]">
                  <div className="space-y-1">
                    <h3 className="text-heading-5 text-secondary/80 font-normal">Automatische concepten</h3>
                    <p className="max-w-[300px]">AI genereert een concept voor elke inkomende e-mail op basis van uw kennisbank en beleid.</p>
                  </div>
              ...
              <div className="flex w-full max-w-[640px] flex-col items-center justify-center gap-y-4 sm:gap-y-2">
                ...
                <RevealAnimation delay={0.2}>
                  <div className="w-full shrink-0 space-y-1 rounded-4xl bg-white p-8 lg:h-[221px] lg:p-[42px]">
                    <h3 className="text-heading-5 text-secondary/80 font-normal">Goedkeuringsflow</h3>
                    <p className="max-w-[230px]">Geen e-mail gaat eruit zonder uw expliciete goedkeuring.</p>
                  </div>
                </RevealAnimation>
                ...
                <RevealAnimation delay={0.3}>
                  <div className="relative w-full shrink-0 space-y-1 overflow-hidden rounded-4xl bg-white p-8 lg:h-[221px] lg:p-[42px]">
                    ...
                    <p>Voeg veelgestelde vragen, productinformatie en beleid toe als context voor de AI.</p>
              ...
              <RevealAnimation delay={0.4}>
                <div className="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                  <div className="flex h-[450px] flex-col items-start justify-between rounded-4xl bg-white p-8 md:p-[42px] xl:w-[317px]">
                    <div className="space-y-1">
                      <h3 className="text-heading-5 text-secondary/80 font-normal">Tone instellingen</h3>
                      <p>Configureer de toon, stijl en de grenzen van AI-antwoorden per inbox.</p>
                    </div>

                    <div className="bg-[#f0fbe3] flex h-[230px] w-full flex-col justify-between rounded-xl p-4 xl:max-w-[233px]">
                      <p className="text-secondary/40 text-tagline-2">Stel uw communicatiestijl in: formeel, informeel, kort of uitgebreid...</p>
              ...
              <RevealAnimation delay={0.5}>
                <div className="relative col-span-12 flex h-[450px] flex-col items-center justify-between overflow-hidden rounded-4xl bg-white p-8 md:col-span-6 md:p-[42px] lg:col-span-4 xl:col-span-3 xl:w-[317px]">
                  ...
                  <div className="relative z-20 space-y-1">
                    <h3 className="text-heading-5 text-secondary/80 font-normal">Teamtoegang</h3>
                    <p>Nodig collega's uit en stel rolgebaseerde rechten in voor uw supportteam.</p>
                  </div>
                  ...
                  <div className="flex h-auto w-full flex-col justify-between space-y-2.5 rounded-xl p-4 max-sm:items-center md:max-w-[233px] lg:h-[166px]">
                    ...
                    <RevealAnimation delay={0.5}>
                      <div className="ml-[25px] flex items-center justify-end gap-x-2">
                        <div className="bg-[#f0fbe3] flex items-center justify-center gap-x-[9px] rounded-[44px] p-1">
                          <span className="text-secondary/40 text-[10px] leading-[150%] font-normal">Admin</span>
                          <figure>
                            <Image src={playIcon} alt="rol" className="size-full" width={16} height={16} />
                          </figure>
                        </div>
                        <figure className="size-[34px] shrink-0 overflow-hidden rounded-full">
                          <Image src={avatar39} alt="team member" className="size-full object-cover" width={34} height={34} />
                        </figure>
                      </div>
                    </RevealAnimation>
                    ...
                    <RevealAnimation delay={0.5}>
                      <div className="mr-[25px] flex flex-row-reverse items-center justify-start gap-x-2">
                        <div className="bg-[#f0fbe3] flex items-center justify-center gap-x-[9px] rounded-[44px] p-1">
                          <span className="text-secondary/40 text-[10px] leading-[150%] font-normal">Reviewer</span>
                          <figure>
                            <Image src={playIcon} alt="rol" className="size-full" width={16} height={16} />
                          </figure>
                        </div>
                        <figure className="size-[34px] shrink-0 overflow-hidden rounded-full">
                          <Image src={icon553} alt="team member" className="size-full object-cover" width={34} height={34} />
                        </figure>
                      </div>
                    </RevealAnimation>
                    ...
                    <RevealAnimation delay={0.6}>
                      <div className="ml-[25px] flex items-center justify-end gap-x-2">
                        <div className="bg-[#f0fbe3] flex items-center justify-center gap-x-[9px] rounded-[44px] p-1">
                          <span className="text-secondary/40 text-[10px] leading-[150%] font-normal">Agent</span>
                          <figure>
                            <Image src={playIcon} alt="rol" className="size-full" width={16} height={16} />
                          </figure>
                        </div>
              ...
              <RevealAnimation delay={0.6}>
                <div className="col-span-12 h-[450px] w-full space-y-[74px] rounded-4xl bg-white pt-[42px] lg:col-span-4 lg:max-w-[500px] xl:col-span-6 xl:max-w-[642px]">
                  <div className="space-y-1 px-[42px]">
                    <h3 className="text-heading-5 text-secondary/80 font-normal">Gmail integratie</h3>
                    <p>Native koppeling met uw Gmail-inbox via OAuth — geen technische setup of API-sleutels nodig.</p>
                  </div>

                  {/* connection options */}
                  <div className="space-y-[54px] pb-[42px] text-center">
                    <div className="flex gap-3 justify-center">
                      {['Gmail', 'OAuth', 'Veilig'].map((item) => (
                        <span
                          key={item}
                          className={`rounded-full px-6 py-3 text-heading-6 font-normal ${
                            item === 'Gmail' ? 'bg-ns-green text-secondary' : 'bg-[#f0fbe3] text-secondary/60'
                          }`}>
                          {item}
                        </span>
                      ))}
